...
class Employer(models.Model):
    ...
    # Category 6 Criteria
    c6c1_nature_of_crime = models.IntegerField(default = 0)
    c6c2_no_housing_history_check = models.IntegerField(default = 0)
    c6c3_no_residence_loc_review = models.IntegerField(default = 0)
    c6c4_no_housing_based_disq = models.IntegerField(default = 0)
    c6c5_no_arrests_inquiry = models.IntegerField(default = 0)
    c6c6_disregards_conviction_beyond_cutoff = models.IntegerField(default = 0)
    c6c6num_year_cutoff = models.IntegerField(null=True, blank = True)
    c6c7_discusses_unfavorable_check = models.IntegerField(default = 0)
    c6c8_no_automatic_dismiss_on_bg_check = models.IntegerField(default = 0)
    c6c9_differentiates_violent_offenses = models.IntegerField(default = 0)
    c6c10_record_is_not_major_barrier = models.IntegerField(default = 0)
    c6c11_dishonesty_insurance = models.IntegerField(default = 0)
